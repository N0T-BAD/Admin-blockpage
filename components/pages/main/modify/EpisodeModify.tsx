...
export default function EpisodeModify() {
  ...
  const handleAccept = () => {
    axios.put(`${baseUrl}/webtoon-service/v1/demands?target=episode&type=modify&whether=accept&episodeId=${episodeId}`, {
  ...
  const handleRefuse = () => {
    axios.put(`${baseUrl}/webtoon-service/v1/demands?target=episode&type=modify&whether=refuse&episodeId=${episodeId}`, {
      memberId: episode.data.author,
    })
      .then((res) => {
        console.log(res)
